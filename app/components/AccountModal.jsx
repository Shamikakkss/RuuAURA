...
export default function AccountModal({ isOpen, onClose }) {
  ...
  const handleCancelBooking = (booking) => {
    if (!booking || !window.confirm(`Cancel your appointment for ${booking.serviceTitle}?`)) return;
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="flex items-center gap-3.5 p-3 rounded-sm bg-white/5 border border-white/10">
                    ...
                    <div className="min-w-0">
                      <p
                        className="text-sm font-semibold text-brand-cream truncate"
                        ...
                        <div className="p-5 rounded-sm bg-brand-card border border-brand-gold/20 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                          <div>
                            ...
                            <p className="text-xs text-brand-muted mt-1">
                              With {upcomingBookings[0].artisanName || upcomingBookings[0].artisan || "Master Artisan"} • {upcomingBookings[0].date} at {upcomingBookings[0].time}
                            </p>
                          </div>
                        ...
                        upcomingBookings.map((b) => (
                          ...
                          >
                            <div>
                              ...
                              <p className="text-xs text-brand-muted mt-1">
                                Artisan: <strong className="text-brand-cream">{b.artisanName || b.artisan || "Artisan"}</strong> • {b.date} at {b.time}
                              </p>
                            </div>
                            <button
                          ...
                          >
                            <div>
                              ...
                              <p className="text-[11px] text-brand-muted">
                                {b.artisanName || b.artisan || "Artisan"} • {b.date} • <span className="font-mono">{b.status}</span>
                              </p>
                            </div>
